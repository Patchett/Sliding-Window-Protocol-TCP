...
(sleep 0.5; for i in `seq 0 299`; do echo "msg 0 0 Packet: $i"; sleep 0.1; done; sleep 35; echo "exit") | ./tritontalk -r 1 -s 1 > .output.7 2> .debug_output.7
(for i in `seq 0 299`; do echo "<RECV_0>:[Packet: $i]"; done) > .expected_output.7
check_output 7
